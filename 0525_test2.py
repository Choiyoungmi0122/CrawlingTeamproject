...
for btn in range(2): 
    ...
    for data in range(len(parking_list)):  #장소 리스트 만큼
        ...
        try:
            ...
            addr = driver.find_elements(By.CSS_SELECTOR, '.bjaFi > div')
...
# json 파일로 저장
with open('/Users/choiyoungmi/anaconda3/envs/bigdata/teamproject/data_test2.json', 'w', encoding='utf-8') as f:
